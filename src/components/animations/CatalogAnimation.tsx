        ...
        <div className="animate-float w-full max-w-sm bg-white rounded-2xl shadow-xl md:shadow-2xl border border-gray-200 overflow-hidden relative z-10 perspective-1000 flex flex-col h-[340px] md:h-[420px]">
            ...
            <div className="p-6 bg-gray-50/50 flex-1">
                <div className="anim-seq-card w-full h-full bg-white rounded-xl border border-gray-200 p-4 relative overflow-hidden transition-all duration-300 flex flex-col justify-between">
                    ...
                    <div className="h-36 rounded-lg bg-gray-100 mb-5 flex items-center justify-center relative overflow-hidden border border-dashed border-gray-300">
                        <svg className="anim-seq-camera w-8 h-8 text-gray-400 absolute z-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="anim-seq-image absolute inset-0 bg-gradient-to-tr from-orange-500 to-orange-300 flex items-center justify-center">
                            <svg className="w-12 h-12 text-white opacity-80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="space-y-3 mb-5">
                        <div className="h-3 rounded-full bg-gray-200 w-0 anim-seq-text1"></div>
                        <div className="h-3 rounded-full bg-gray-200 w-0 anim-seq-text2"></div>
                    </div>

                    <div className="flex gap-2 mb-6">
                        <div className="w-6 h-6 rounded-full bg-orange-500 shadow-inner anim-seq-dot1 opacity-0"></div>
                        <div className="w-6 h-6 rounded-full bg-gray-800 shadow-inner anim-seq-dot2 opacity-0"></div>
                        <div className="w-6 h-6 rounded-full bg-orange-200 shadow-inner anim-seq-dot3 opacity-0 border border-gray-200"></div>
                    </div>

                    <div className="anim-seq-button w-full h-10 bg-orange-500 rounded-lg flex items-center justify-center shadow-lg shadow-orange-500/30 relative overflow-hidden">
